...
::String System_obj::get_deviceID( ){
	...
	HX_STACK_LINE(43)
	return ::openfl::_legacy::system::System_obj::lime_get_unique_device_identifier();
}
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._legacy.system.System"), hx::TCanCast< System_obj> ,sStaticFields,sMemberFields,
...
{
	lime_get_unique_device_identifier= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime-legacy"),HX_CSTRING("lime_legacy_get_unique_device_identifier"),(int)0);
}
