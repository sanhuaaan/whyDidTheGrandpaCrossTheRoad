...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "WDTGCTR", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "WDTGCTR";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "WDTGCTR", null, { width: 720, height: 480 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 720, height: 480 });
			#end
...
class ApplicationMain {
	...
	public static function create ():Void {
		...
		urls.push ("assets/images/andador.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/andadorx39.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/coches.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/dead.png");
		types.push (lime.Assets.AssetType.IMAGE);
		...
		urls.push ("assets/images/fondoMAL.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/hit.png");
		types.push (lime.Assets.AssetType.IMAGE);
		...
		urls.push ("assets/images/player1x26.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/player1x39.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/playersx39.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/portadaP1.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/portadaP2.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/music/intro.wav");
		types.push (lime.Assets.AssetType.SOUND);
		
		
		urls.push ("assets/music/loop.wav");
		types.push (lime.Assets.AssetType.SOUND);
		...
		urls.push ("assets/sounds/end.wav");
		types.push (lime.Assets.AssetType.SOUND);
		...
		urls.push ("assets/sounds/point.wav");
		types.push (lime.Assets.AssetType.SOUND);
		
		
		urls.push ("assets/sounds/ready.wav");
		types.push (lime.Assets.AssetType.SOUND);
	...
	public static function main () {
		...
		#if (js && html5)
		#if (munit || utest)
		openfl.Lib.embed (null, 720, 480, "null");
		#end
		#else
		create ();
		#end
